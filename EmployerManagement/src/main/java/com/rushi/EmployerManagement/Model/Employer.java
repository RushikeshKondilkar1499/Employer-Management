...
public class Employer {
	...
	public String toString() {
		return "Employer [empId=" + empId + ", empName=" + empName + ", employerType=" + employerType + ", masterCode="
				+ masterCode + ", subsidaryCode=" + subsidaryCode + ", registrationId=" + registrationId
				+ ", employerCategory=" + employerCategory + ", employergrade=" + employergrade + ", address=" + address
				+ ", country=" + country + ", rmName=" + rmName + ", mobileNo=" + mobileNo + ", email=" + email
				+ ", revenue=" + revenue + ", profit=" + profit + ", debt=" + debt + ", noOfEmployees=" + noOfEmployees
